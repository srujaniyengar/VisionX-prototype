...
export default function Stepper({
  ...
  const { 'data-replit-metadata': _, ...cleanRest } = rest;
  
  return (
    <div className="outer-container" {...cleanRest}>
    ...
    <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: '#20b2aa', color: '#20b2aa' },
          complete: { scale: 1, backgroundColor: '#20b2aa', color: '#20b2aa' }
        }}
...
function StepConnector({ isComplete }: { isComplete: boolean }) {
  const lineVariants = {
    ...
    complete: { width: '100%', backgroundColor: '#20b2aa' }
  };
